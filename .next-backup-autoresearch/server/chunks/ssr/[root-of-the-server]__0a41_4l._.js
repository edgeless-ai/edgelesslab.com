...
The best time to set up memory is before your next session. Takes 15 minutes, saves hours every week.
    `.trim()}]])},58745,a=>{"use strict";a.s(["BlogPostCard",()=>b]);let b=(0,a.i(6533).registerClientReference)(function(){throw Error("Attempted to call BlogPostCard() from the server but BlogPostCard is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.")},"[project]/claude-projects/edgeless-website/src/components/blog-client.tsx <module evaluation>","BlogPostCard")},80275,a=>{"use strict";a.s(["BlogPostCard",()=>b]);let b=(0,a.i(6533).registerClientReference)(function(){throw Error("Attempted to call BlogPostCard() from the server but BlogPostCard is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.")},"[project]/claude-projects/edgeless-website/src/components/blog-client.tsx","BlogPostCard")},39504,a=>{"use strict";a.i(58745);var b=a.i(80275);a.n(b)},97887,a=>{"use strict";var b=a.i(67286),c=a.i(95873),d=a.i(29348),e=a.i(31287),f=a.i(39504);let g=(0,a.i(90621).createPageMetadata)({title:"Blog",description:"Notes on building AI agents, MCP servers, generative art, and developer tools.",path:"/blog",keywords:["AI engineering blog","MCP servers","Claude Code","developer tools"]});a.s(["default",0,function(){return(0,b.jsxs)("div",{className:"flex flex-col min-h-full",style:{background:"var(--bg-base)"},children:[(0,b.jsx)(d.Nav,{}),(0,b.jsx)("main",{className:"pt-28 pb-20 px-6",children:(0,b.jsxs)("div",{className:"max-w-[800px] mx-auto",children:[(0,b.jsx)("h1",{className:"text-3xl font-bold tracking-tight mb-2",style:{color:"var(--text-primary)"},children:"Blog"}),(0,b.jsx)("p",{className:"text-sm mb-12",style:{color:"var(--text-secondary)",lineHeight:1.7},children:"Notes on building AI agents, generative art, and developer tools."}),(0,b.jsx)("div",{className:"space-y-1",children:c.posts.map(a=>(0,b.jsx)(f.BlogPostCard,{post:a},a.slug))})]})}),(0,b.jsx)(e.Footer,{})]})},"metadata",0,g])},39117,a=>{a.n(a.i(97887))}];

//# sourceMappingURL=%5Broot-of-the-server%5D__0a41_4l._.js.map