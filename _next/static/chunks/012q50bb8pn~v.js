(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,25062,34311,16300,e=>{"use strict";var t=e.i(74092);e.s(["AnimatedFadeIn",0,function({children:e,className:a,delay:o=0}){return(0,t.jsxs)("div",{className:a,style:{animation:`fadeInUpSimple 0.6s cubic-bezier(0.16,1,0.3,1) ${o}s both`},children:[e,(0,t.jsx)("style",{children:`
        @keyframes fadeInUpSimple {
          from { opacity: 0; transform: translateY(16px); }
          to { opacity: 1; transform: translateY(0); }
        }
      `})]})},"AnimatedText",0,function({text:e,className:a,delay:o=0}){let s=e.split(" ");return(0,t.jsxs)("span",{className:a,children:[s.map((e,a)=>(0,t.jsx)("span",{className:"inline-block mr-[0.25em]",style:{animation:`fadeInUp 0.5s cubic-bezier(0.16,1,0.3,1) ${o+.08*a}s both`},children:e},a)),(0,t.jsx)("style",{children:`
        @keyframes fadeInUp {
          from { opacity: 0; transform: translateY(20px); filter: blur(8px); }
          to { opacity: 1; transform: translateY(0); filter: blur(0); }
        }
      `})]})}],25062);var a=e.i(43041),o=e.i(58201);let s=["lorenz","rossler","spiral","flow"],i=[[235,85],[160,70],[270,75],[210,80],[330,65],[180,60]];e.s(["GenerativeHeroBackground",0,function(){let e=(0,a.useRef)(null),n=(0,a.useRef)(0),r=(0,a.useRef)(null),[l,h]=(0,a.useState)(!1),c=(0,o.useReducedMotion)(),d=(0,a.useCallback)(e=>{var t;let a=(Date.now()^0xffffffff*Math.random())>>>0,o=(t=a,()=>{t|=0;let e=Math.imul((t=t+0x6d2b79f5|0)^t>>>15,1|t);return(((e=e+Math.imul(e^e>>>7,61|e)^e)^e>>>14)>>>0)/0x100000000}),n=s[Math.floor(o()*s.length)],l=i[Math.floor(o()*i.length)],h=e.width,c=e.height;r.current={particles:Array.from({length:200},()=>{let e=o()*h,t=o()*c;return{x:e,y:t,prevX:e,prevY:t,vx:(o()-.5)*2,vy:(o()-.5)*2,life:Math.floor(250*o())+80,maxLife:330,hueOffset:(o()-.5)*40}}),type:n,seed:a,rng:o,cx1:h*(.2+.6*o()),cy1:c*(.2+.6*o()),cx2:h*(.2+.6*o()),cy2:c*(.2+.6*o()),cx3:h*(.2+.6*o()),cy3:c*(.2+.6*o()),strength:.012+.025*o(),baseHue:l[0]+(o()-.5)*30,baseSat:l[1],hueRange:20+40*o(),trailFade:.03+.03*o(),time:0}},[]);return(0,a.useEffect)(()=>{if(c)return;let t=e.current;if(!t)return;let a=t.getContext("2d");if(!a)return;let o=0,s=0,i=()=>{let e=Math.min(window.devicePixelRatio||1,2),i=t.getBoundingClientRect();o=i.width,s=i.height,t.width=i.width*e,t.height=i.height*e,a.scale(e,e),d(t)},l=()=>{setTimeout(()=>{i(),h(!0)},100)};window.matchMedia("(prefers-reduced-motion: reduce)").matches||navigator.hardwareConcurrency<=4?setTimeout(l,500):"requestIdleCallback"in window?window.requestIdleCallback(l,{timeout:2e3}):setTimeout(l,100);let u=()=>{let e=r.current;if(!e)return;e.time++,a.fillStyle=`rgba(0, 0, 0, ${e.trailFade})`,a.fillRect(0,0,o,s);let i=o/t.width,l=s/t.height;for(let n of(a.beginPath(),e.particles)){!function(e,t,a,o){e.prevX=e.x,e.prevY=e.y;let s=0,i=0,{type:n,cx1:r,cy1:l,cx2:h,cy2:c,cx3:d,cy3:u,strength:p,time:m}=t;switch(n){case"lorenz":{let t=r-e.x,a=l-e.y,o=h-e.x,n=c-e.y,m=Math.sqrt(t*t+a*a)+1,g=Math.sqrt(o*o+n*n)+1,f=d-e.x,y=u-e.y,w=Math.sqrt(f*f+y*y)+1;s=(t/m-n/g+f/w*.3)*p,i=(a/m+o/g-y/w*.3)*p;break}case"rossler":{let t=r-e.x,a=l-e.y,o=Math.sqrt(t*t+a*a)+1,n=.005*Math.sin(.002*m);s=(-a/o+t*(.008+n))*p,i=(t/o+a*(.008+n))*p;let d=h-e.x,u=c-e.y,g=Math.sqrt(d*d+u*u)+1;s+=u/g*p*.2,i-=d/g*p*.2;break}case"spiral":{let t=r-e.x,a=l-e.y,o=Math.sqrt(t*t+a*a)+1,n=Math.atan2(a,t)+.3+.2*Math.sin(.001*m);s=Math.cos(n)/o*p*8,i=Math.sin(n)/o*p*8;let d=h-e.x,u=c-e.y,g=Math.sqrt(d*d+u*u)+1,f=Math.atan2(u,d)-.5;s+=Math.cos(f)/g*p*3,i+=Math.sin(f)/g*p*3;break}case"flow":{let t=.002+5e-4*Math.sin(5e-4*m),n=Math.sin(e.x*t+.001*m)*Math.cos(e.y*t*.7),r=Math.cos(e.x*t*.8-8e-4*m)*Math.sin(e.y*t);s=n*p*1.5,i=r*p*1.5,s+=(.5*a-e.x)*1e-5,i+=(.5*o-e.y)*1e-5}}e.vx+=s,e.vy+=i,e.vx*=.982,e.vy*=.982,e.x+=e.vx,e.y+=e.vy,e.life--,e.life<=0&&(e.x=t.rng()*a,e.y=t.rng()*o,e.prevX=e.x,e.prevY=e.y,e.vx=(t.rng()-.5)*2,e.vy=(t.rng()-.5)*2,e.life=Math.floor(250*t.rng())+80,e.hueOffset=(t.rng()-.5)*40),e.x<-20&&(e.x=-20,e.vx*=-.5),e.x>a+20&&(e.x=a+20,e.vx*=-.5),e.y<-20&&(e.y=-20,e.vy*=-.5),e.y>o+20&&(e.y=o+20,e.vy*=-.5)}(n,e,t.width,t.height);let r=n.life/n.maxLife,h=r>.9?(1-r)*10:r<.2?5*r:1,c=Math.sqrt(n.vx*n.vx+n.vy*n.vy),d=h*Math.min(.8,.2+.15*c),u=.5+.4*c,p=e.baseHue+n.hueOffset+Math.sin(.003*e.time+n.hueOffset)*e.hueRange*.3,m=n.prevX*i,g=n.prevY*l,f=n.x*i,y=n.y*l,w=Math.abs(y-g);Math.abs(f-m)>.3*o||w>.3*s||(a.beginPath(),a.moveTo(m,g),a.lineTo(f,y),a.strokeStyle=`hsla(${p}, ${e.baseSat}%, 65%, ${d})`,a.lineWidth=u,a.lineCap="round",a.stroke(),c>2.5&&e.time%2==0&&(a.beginPath(),a.arc(f,y,u+2,0,2*Math.PI),a.fillStyle=`hsla(${p}, ${e.baseSat}%, 70%, ${.3*d})`,a.fill()))}n.current=requestAnimationFrame(u)},p=setTimeout(()=>{n.current=requestAnimationFrame(u)},250);return window.addEventListener("resize",i),()=>{clearTimeout(p),cancelAnimationFrame(n.current),window.removeEventListener("resize",i)}},[d,c]),(0,t.jsxs)("div",{className:"pointer-events-none absolute inset-0 overflow-hidden",children:[(0,t.jsx)("div",{className:"absolute inset-0",style:{backgroundImage:"linear-gradient(rgba(255,255,255,0.03) 1px, transparent 1px), linear-gradient(90deg, rgba(255,255,255,0.03) 1px, transparent 1px)",backgroundSize:"64px 64px"}}),(0,t.jsx)("canvas",{ref:e,className:"absolute inset-0 w-full h-full",style:{opacity:.55*!!l,willChange:"transform",transition:"opacity 0.5s ease-out"}}),(0,t.jsx)("div",{className:"absolute inset-0",style:{background:"radial-gradient(ellipse 80% 60% at 50% 40%, transparent 0%, rgba(0,0,0,0.65) 100%)"}})]})}],34311);let n=[{slug:"real-cost-ai-agents-production-2026",editorial:!0,title:"The Real Cost of Running AI Agents in Production — A Monthly Breakdown (2026)",description:"Your AI agent costs 5–15× more in production than your prototype. Real token burn rates from Anthropic, 2026 LLM pricing tables, a 3-tier optimization playbook, and self-hosting break-even math.",date:"2026-05-06",tags:["AI Agents","LLM Pricing","Cost Optimization","Production"],readTime:"12 min",content:`
