(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,17222,91001,25062,e=>{"use strict";let t=(0,e.i(42175).default)("arrow-right",[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"m12 5 7 7-7 7",key:"xquz4c"}]]);e.s(["ArrowRight",0,t],17222);var a=e.i(74092),s=e.i(63560);e.s(["GlowingCard",0,function({children:e,className:t="",href:o,glowColor:r="var(--accent)"}){let n=(0,a.jsxs)("div",{className:`group relative overflow-hidden rounded-2xl border p-8 transition-all duration-200 hover:scale-[1.01] ${t}`,style:{background:"var(--bg-surface)",borderColor:"var(--border-subtle)"},children:[(0,a.jsx)("div",{className:"pointer-events-none absolute -inset-px rounded-2xl opacity-0 transition-opacity duration-300 group-hover:opacity-100",style:{background:`radial-gradient(600px circle at var(--mouse-x, 50%) var(--mouse-y, 50%), ${r}10, transparent 40%)`}}),(0,a.jsx)("div",{className:"pointer-events-none absolute inset-x-0 top-0 h-px opacity-0 transition-opacity duration-300 group-hover:opacity-100",style:{background:`linear-gradient(90deg, transparent, ${r}30, transparent)`}}),(0,a.jsx)("div",{className:"relative",children:e})]});return o?o.startsWith("/")?(0,a.jsx)(s.default,{href:o,children:n}):(0,a.jsx)("a",{href:o,target:"_blank",rel:"noopener noreferrer",children:n}):n}],91001),e.s(["AnimatedFadeIn",0,function({children:e,className:t,delay:s=0}){return(0,a.jsxs)("div",{className:t,style:{animation:`fadeInUpSimple 0.6s cubic-bezier(0.16,1,0.3,1) ${s}s both`},children:[e,(0,a.jsx)("style",{children:`
        @keyframes fadeInUpSimple {
          from { opacity: 0; transform: translateY(16px); }
          to { opacity: 1; transform: translateY(0); }
        }
      `})]})},"AnimatedText",0,function({text:e,className:t,delay:s=0}){let o=e.split(" ");return(0,a.jsxs)("span",{className:t,children:[o.map((e,t)=>(0,a.jsx)("span",{className:"inline-block mr-[0.25em]",style:{animation:`fadeInUp 0.5s cubic-bezier(0.16,1,0.3,1) ${s+.08*t}s both`},children:e},t)),(0,a.jsx)("style",{children:`
        @keyframes fadeInUp {
          from { opacity: 0; transform: translateY(20px); filter: blur(8px); }
          to { opacity: 1; transform: translateY(0); filter: blur(0); }
        }
      `})]})}],25062)},43875,e=>{"use strict";var t=e.i(74092),a=e.i(43041),s=e.i(63560),o=e.i(17222),r=e.i(29114),n=e.i(91001),i=e.i(25);let l={segmentIndex:0,graphemeIndex:0};function c({segments:e,className:s,style:o}){let r=(0,a.useRef)(null),[n,h]=(0,a.useState)(0),{ready:d,prepareWithSegments:u,layoutNextLine:p}=(0,i.usePreText)("Geist");(0,a.useEffect)(()=>{if(!r.current)return;let e=()=>{r.current&&h(r.current.clientWidth)};e();let t=new ResizeObserver(e);return t.observe(r.current),()=>t.disconnect()},[]);let m=(0,a.useMemo)(()=>{if(!d||!u||!p||n<=0)return null;let t=e.map(e=>({prepared:u(e.text,e.font),segment:e}));if(t.some(e=>!e.prepared))return null;let a=[],s=Math.max(...e.map(e=>e.lineHeight)),o=0,r=[],i=n;for(let{prepared:e,segment:c}of t){if(!e)continue;let t=p(e,l,1e5);if(t)if(t.width<=i)r.push({text:t.text,width:t.width,style:c.style,font:c.font}),i-=t.width;else{let t=l;for(;;){let l=p(e,t,Math.max(1,i));if(!l)break;if(r.push({text:l.text,width:l.width,style:c.style,font:c.font}),l.end.segmentIndex>=e.segments.length||l.end.segmentIndex===e.segments.length-1&&l.end.graphemeIndex>=e.segments[e.segments.length-1].length){i-=l.width;break}a.push({fragments:r,y:o,lineHeight:s}),o+=s,r=[],i=n,t=l.end}}}return r.length>0&&(a.push({fragments:r,y:o,lineHeight:s}),o+=s),{lines:a,totalHeight:o}},[d,u,p,e,n]);return m?(0,t.jsx)("div",{ref:r,className:s,style:{...o,position:"relative",height:`${m.totalHeight}px`},children:m.lines.map((e,a)=>(0,t.jsx)("div",{style:{position:"absolute",top:`${e.y}px`,left:0,height:`${e.lineHeight}px`,lineHeight:`${e.lineHeight}px`,whiteSpace:"pre"},children:e.fragments.map((e,a)=>(0,t.jsx)("span",{style:{...e.style,font:e.font},children:e.text},a))},a))}):(0,t.jsx)("div",{ref:r,className:s,style:{...o,whiteSpace:"pre-wrap"},children:e.map((e,a)=>(0,t.jsx)("span",{style:{...e.style,font:e.font},children:e.text},a))})}function h({text:e,font:s='300 14px "Geist"',lineHeight:o=24,orbCount:r=3,orbRadius:n=40,className:l,style:c,textColor:d="var(--text-secondary)"}){let{ready:u,prepareWithSegments:p,layoutNextLine:m}=(0,i.usePreText)("Geist"),g=(0,a.useRef)(null),f=(0,a.useRef)(null),y=(0,a.useRef)(null),w=(0,a.useRef)([]),v=(0,a.useRef)(0),[b,k]=(0,a.useState)({width:0,height:0}),x=(0,a.useRef)(-1),T=(0,a.useRef)({x:0,y:0});(0,a.useEffect)(()=>{if(0===b.width)return;let e=b.width,t=b.height||300,a=["rgba(129,140,248,0.12)","rgba(34,197,94,0.10)","rgba(129,140,248,0.08)"];w.current=Array.from({length:r},(s,o)=>({x:e*(.25+.5*Math.random()),y:t*(.25+.5*Math.random()),vx:(Math.random()-.5)*1.5,vy:(Math.random()-.5)*1.5,radius:n+15*Math.random(),color:a[o%a.length],dragging:!1}))},[b.width,b.height,r,n]),(0,a.useEffect)(()=>{if(!g.current)return;let e=()=>{if(g.current){let{width:e}=g.current.getBoundingClientRect();k({width:e,height:280})}};e();let t=new ResizeObserver(e);return t.observe(g.current),()=>t.disconnect()},[u]),(0,a.useEffect)(()=>{if(!u||!p||!m||0===b.width)return;let t=p(e,s);if(!t)return;let a=f.current,r=y.current;if(!a||!r)return;let n=a.getContext("2d");if(!n)return;let i=b.width,l=window.devicePixelRatio||1,c=()=>{let e=w.current;for(let t of e)!t.dragging&&(t.x+=t.vx,t.y+=t.vy,t.x-t.radius<0&&(t.x=t.radius,t.vx*=-.8),t.x+t.radius>i&&(t.x=i-t.radius,t.vx*=-.8),t.y-t.radius<0&&(t.y=t.radius,t.vy*=-.8),t.vx*=.999,t.vy*=.999,.3>Math.sqrt(t.vx*t.vx+t.vy*t.vy)&&(t.vx+=(Math.random()-.5)*.2,t.vy+=(Math.random()-.5)*.2));for(let t=0;t<e.length;t++)for(let a=t+1;a<e.length;a++){let s=e[t],o=e[a],r=o.x-s.x,n=o.y-s.y,i=Math.sqrt(r*r+n*n),l=s.radius+o.radius;if(i<l&&i>0){let e=r/i,t=n/i,a=(l-i)/2;s.dragging||(s.x-=e*a,s.y-=t*a),o.dragging||(o.x+=e*a,o.y+=t*a);let c=(o.vx-s.vx)*e+(o.vy-s.vy)*t;s.dragging||(s.vx+=c*e*.5,s.vy+=c*t*.5),o.dragging||(o.vx-=c*e*.5,o.vy-=c*t*.5)}}let h=[],u={segmentIndex:0,graphemeIndex:0},p=0,g=t.segments.length,f=200;for(;(u.segmentIndex<g||u.graphemeIndex>0)&&p<280&&f-- >0;){let a=0,s=i;for(let t of e){let e=t.y-t.radius,r=t.y+t.radius;if(p+o>e&&p<r){let e=p+o/2-t.y,r=Math.sqrt(Math.max(0,t.radius*t.radius-e*e)),n=t.x-r-8,l=t.x+r+8,c=Math.max(0,n),h=Math.max(0,i-l);if(c>=h&&c>60)s=c,a=0;else if(h>60)a=l,s=h;else{p+=o;continue}}}if(s<40){p+=o;continue}let r=m(t,u,s);if(!r||r.end.segmentIndex===u.segmentIndex&&r.end.graphemeIndex===u.graphemeIndex)break;r.text.trim()&&h.push({x:a,y:p,text:r.text}),u=r.end,p+=o}for(let t of(a.width=i*l,a.height=280*l,a.style.width=`${i}px`,a.style.height="280px",n.scale(l,l),n.clearRect(0,0,i,280),e)){let e=n.createRadialGradient(t.x,t.y,0,t.x,t.y,t.radius);e.addColorStop(0,t.color.replace(/[\d.]+\)$/,"0.15)")),e.addColorStop(.7,t.color),e.addColorStop(1,"transparent"),n.beginPath(),n.arc(t.x,t.y,t.radius,0,2*Math.PI),n.fillStyle=e,n.fill(),n.beginPath(),n.arc(t.x,t.y,t.radius,0,2*Math.PI),n.strokeStyle=t.color.replace(/[\d.]+\)$/,"0.3)"),n.lineWidth=1,n.stroke()}for(let e of(r.innerHTML="",r.style.height="280px",h)){let t=document.createElement("div");t.style.position="absolute",t.style.left=`${e.x}px`,t.style.top=`${e.y}px`,t.style.font=s,t.style.color=d,t.style.whiteSpace="nowrap",t.style.lineHeight=`${o}px`,t.textContent=e.text,r.appendChild(t)}for(let t of e)t.y+t.radius>270&&(t.y=280-t.radius-10,t.vy*=-.8);v.current=requestAnimationFrame(c)};return v.current=requestAnimationFrame(c),()=>cancelAnimationFrame(v.current)},[u,p,m,b.width,e,s,o,d]);let A=(0,a.useCallback)(e=>{let t=g.current?.getBoundingClientRect();if(!t)return;let a=e.clientX-t.left,s=e.clientY-t.top;for(let t=0;t<w.current.length;t++){let o=w.current[t],r=a-o.x,n=s-o.y;if(r*r+n*n<o.radius*o.radius){x.current=t,T.current={x:r,y:n},o.dragging=!0,o.vx=0,o.vy=0,e.target.setPointerCapture(e.pointerId);return}}},[]),I=(0,a.useCallback)(e=>{if(x.current<0)return;let t=g.current?.getBoundingClientRect();if(!t)return;let a=w.current[x.current];a&&(a.x=e.clientX-t.left-T.current.x,a.y=e.clientY-t.top-T.current.y)},[]),C=(0,a.useCallback)(()=>{if(x.current>=0){let e=w.current[x.current];e&&(e.dragging=!1)}x.current=-1},[]);return u?(0,t.jsxs)("div",{ref:g,className:l,style:{...c,position:"relative",height:280,overflow:"hidden",cursor:"default"},onPointerDown:A,onPointerMove:I,onPointerUp:C,children:[(0,t.jsx)("canvas",{ref:f,style:{position:"absolute",top:0,left:0,zIndex:0,pointerEvents:"none"}}),(0,t.jsx)("div",{ref:y,style:{position:"absolute",top:0,left:0,width:"100%",zIndex:1,pointerEvents:"none"}})]}):(0,t.jsx)("div",{className:l,style:c,children:(0,t.jsx)("p",{style:{color:d,font:s,lineHeight:`${o}px`},children:e})})}var d=e.i(81154);let u="utm_source=edgelesslab&utm_medium=website&utm_campaign=products",p=[{name:"CLAUDE.md Template Pack",price:"Free",description:"14 battle-tested CLAUDE.md templates for every project type. Drop one into your repo and start building.",features:["14 templates: iOS, Android, ML, API, DevOps, Next.js, and more","CLI Tools, Monorepos, and Game Dev configurations","Embedded/IoT, Security Audits, and Open Source templates","Startup MVP and Technical Writing presets"],href:`https://edgelessai.gumroad.com/l/kszapk?${u}`,badge:"Free"},{name:"Quick Reference Cards",price:"Free",description:"Printable cheat sheets for prompt patterns, Claude Code shortcuts, MCP tool reference, and common workflows.",features:["Prompt pattern and system prompt reference cards","Claude Code shortcuts and slash commands","Token optimization and temperature settings guide","PDF and markdown formats, pin-next-to-monitor ready"],href:`https://edgelessai.gumroad.com/l/dihxts?${u}`,badge:"Free"},{name:"Claude Code Cheat Sheet",price:"Free",description:"Quick-start reference for Claude Code. Commands, shortcuts, hook patterns, and MCP setup in one printable sheet.",features:["All slash commands and keyboard shortcuts","Hook configuration patterns with examples","MCP server setup cheatsheet","CLAUDE.md template and memory system quick-start"],href:`https://edgelessai.gumroad.com/l/claude-code-cheat-sheet?${u}`,badge:"Free",slug:"claude-code-cheat-sheet"},{name:"Claude Memory Kit",price:"Free",description:"Start here. Drop-in memory template for Claude Code. Persists context, feedback, and project knowledge across conversations.",features:["4 memory types: user, feedback, project, reference","MEMORY.md index auto-loaded each session","CLAUDE.md snippet for instant setup","Real-world examples included"],href:"https://github.com/edgeless-ai/claude-memory-kit?utm_source=edgelesslab&utm_medium=website&utm_campaign=products",badge:"Free",repoUrl:"https://github.com/edgeless-ai/claude-memory-kit"},{name:"Edgeless Stack",price:"Free",description:"The complete AI agent infrastructure. Memory that persists, hooks that protect, skills that compound, and agents that run while you sleep. Extracted from 3+ months of production use.",features:["3-layer memory: SQLite ledger + ChromaDB vectors + Obsidian vault","6 safety hooks: damage control, completion verification, taxonomy guard","9 skills with tiered loading (5 core + 4 domain)","Cron patterns, Agent Bus, Docker compose, install.sh"],href:"https://github.com/edgeless-ai/edgeless-stack?utm_source=edgelesslab&utm_medium=website&utm_campaign=products",badge:"Free",repoUrl:"https://github.com/edgeless-ai/edgeless-stack"},{name:"Multi-Agent Orchestration Blueprint",price:"Free",description:"The dispatch/worker architecture for coordinating multiple AI agents. Agent Bus messaging, async inboxes, state machines, and 3 reference implementations from a system that runs 5 agents 24/7.",features:["Dispatch/worker topology: routing tasks to specialist agents","Agent Bus setup: real-time inter-session messaging patterns","State machines: queued -> acked -> running -> done/failed","3 reference pipelines: research, code review, content processing"],href:`https://edgelessai.gumroad.com/l/multi-agent-blueprint?${u}`,badge:"New",comingSoon:!1,slug:"multi-agent-blueprint"},{name:"The Agent Cookbook",price:"Free",description:"Build AI agents that actually work. 15 production-ready agent patterns with complete implementations for Claude, GPT, and open-source models.",features:["15 production-ready agent patterns with working code","Memory systems, tool integration, and context management","Error recovery and deployment strategies","Architecture diagrams and production lessons learned"],href:`https://edgelessai.gumroad.com/l/plbzo?${u}`,badge:null},{name:"Claude Memory Kit Pro",price:"Free",description:"The complete memory system for Claude Code power users. 12 templates, 5 stack libraries, advanced patterns guide, and CLAUDE.md templates.",features:["12 ready-to-customize memory templates","Stack libraries: React/Next.js, Python/FastAPI, Go, Rails, Rust","Advanced patterns: multi-project, team memory, CI integration","CLAUDE.md templates for solo and monorepo projects"],href:`https://edgelessai.gumroad.com/l/claude-memory-kit?${u}`,badge:"Popular"},{name:"The Prompt Engineering OS",price:"Free",description:"The complete system for writing AI prompts that work in production. 30 chapters, 8 template schemas, 100+ templates.",features:["30 chapters covering every prompt pattern","8 template schemas with fill-in-the-blank structure","100+ production-tested prompt templates","Covers Claude, GPT-4, Gemini, and open models"],href:`https://edgelessai.gumroad.com/l/prompt-engineering-os?${u}`,badge:null},{name:"Generative Art Starter Kit",price:"Free",description:"10 Python generators for pen plotters: flow fields, L-systems, Voronoi, spirals, reaction-diffusion. Each with parameter guides, example SVGs, and AI scoring rubrics from 105+ experiments.",features:["10 generators with source code, parameter guides, and 3 example outputs each","SVG optimization for pen plotters: stroke ordering, travel minimization","AI scoring rubric for evaluating generative art quality","Print-ready export: A4, A3, letter sizes with plotter setup guides"],href:`https://edgelessai.gumroad.com/l/gen-art-starter?${u}`,badge:"New",comingSoon:!1,slug:"gen-art-starter"},{name:"Always-On Agent Deployment Kit",price:"Free",description:"Deploy an AI agent that runs 24/7 on a $5 VPS. Cron scheduling, grounding packets, memory contracts, Telegram alerting, and the recovery patterns from 3 months of unattended operation.",features:["VPS setup guide: Hetzner, systemd, PM2, environment hardening","Cron job architecture: health checks, email triage, knowledge consolidation","Grounding stack: verification layers, evidence-based completion, session packets","Communication patterns: Telegram bot, inbox dispatch, API access"],href:`https://edgelessai.gumroad.com/l/always-on-agent?${u}`,badge:"New",comingSoon:!0,slug:"always-on-agent"},{name:"Production MCP Server Kit",price:"Free",description:"Take MCP servers past the tutorial stage. Auth middleware, rate limiting, Docker deployment, health checks, and error handling patterns from running 4+ MCP servers in production.",features:["Auth middleware: API key validation and OAuth2 token checking","Rate limiting, usage tracking, and health check endpoints","Docker + compose deployment configs with monitoring","3 production server examples: filesystem, database, external API"],href:`https://edgelessai.gumroad.com/l/production-mcp-kit?${u}`,badge:"New",comingSoon:!1,slug:"production-mcp-kit"},{name:"AI Code Review Playbook",price:"Free",description:"Systematic AI-powered code review that catches security vulnerabilities, performance issues, and logic errors before they ship.",features:["Review checklists and prompt templates for Claude/GPT","GitHub Actions and CI/CD integration guides","Security vulnerability and performance issue detection","Built from real experience reviewing thousands of PRs"],href:`https://edgelessai.gumroad.com/l/uacjr?${u}`,badge:null},{name:"Digital Product Launch Toolkit",price:"Free",description:"The exact process used to ship 18 digital products as a solo developer. Gumroad page templates, pricing strategy, launch checklists, and the daily shipping workflow.",features:["3 Gumroad page layouts: simple, detailed, and premium tiers","Pricing strategy guide: why $9/$14/$19/$24/$29/$39 tiers work","18-step launch checklist from idea to live listing","Cross-sell and bundle strategies with real revenue examples"],href:`https://edgelessai.gumroad.com/l/launch-toolkit?${u}`,badge:"New",comingSoon:!1,slug:"launch-toolkit"},{name:"n8n AI Workflow Templates",price:"Free",description:"5 importable n8n workflows that connect AI to real business processes. YouTube monitoring, RSS intelligence, AI code review, content embedding, and scheduled health checks.",features:["5 ready-to-import n8n workflow JSON files","YouTube monitor -> Claude summary -> email digest pipeline","RSS aggregator -> AI analysis -> Telegram notification","Docker n8n setup guide with environment configuration"],href:`https://edgelessai.gumroad.com/l/n8n-ai-workflows?${u}`,badge:"New",comingSoon:!1,slug:"n8n-ai-workflows"},{name:"MCP Server Starter Kit",price:"Free",description:"TypeScript and Python templates for building MCP servers. Go from zero to a running server in under an hour.",features:["TypeScript and Python server templates","8-chapter guide from architecture to deployment","3 working example servers: file search, database query, API proxy","Complete build-to-deploy walkthrough"],href:`https://edgelessai.gumroad.com/l/lixicg?${u}`,badge:null},{name:"Obsidian + Claude Code Setup Kit",price:"Free",description:"Turn Obsidian into an AI-powered development environment with pre-configured vault, Claude Code integration, and workflow automations.",features:["Pre-configured vault with Claude Code integration","CLAUDE.md templates and hook configurations","Custom templates and plugin recommendations","Complete knowledge management system for AI developers"],href:`https://edgelessai.gumroad.com/l/fyuwpn?${u}`,badge:null},{name:"Prompt Testing Framework",price:"Free",description:"Regression testing, A/B comparison templates, and quality scoring rubrics for AI prompts. Built for teams shipping AI features.",features:["Regression testing and A/B comparison templates","Quality scoring rubrics with structured evaluation criteria","Test harnesses for Claude, GPT, and Gemini","Repeatable, measurable prompt quality workflows"],href:`https://edgelessai.gumroad.com/l/yrail?${u}`,badge:null},{name:"Autonomous Agent Safety Patterns",price:"Free",description:"Hard-won guardrails from an agent that lost $252 of real money. Financial verification protocols, destructive operation prevention, scope containment, and the incident response playbook.",features:["Full post-mortem: the $252 USDC loss and what changed after","10 anti-patterns with production fixes and hook implementations","Financial transaction verification protocol (test small, verify, confirm)","Scope containment patterns: keeping agents within boundaries"],href:`https://edgelessai.gumroad.com/l/agent-safety-patterns?${u}`,badge:"New",comingSoon:!1,slug:"agent-safety-patterns"},{name:"Claude Code Hooks Deep Dive",price:"Free",description:"15 production hooks beyond the basics. The damage-control hook that blocks destructive commands. The verify-completion hook that won't let you lie about finishing. Session init, memory flush, pre-commit guards.",features:["15 battle-tested hooks with full source and walkthroughs","damage-control.py: the hook that saved the codebase from rm -rf","Hook composition patterns: chaining, conditional, env-aware","Template hooks for common scenarios you can customize in minutes"],href:`https://edgelessai.gumroad.com/l/hooks-deep-dive?${u}`,badge:"New",comingSoon:!1,slug:"hooks-deep-dive"},{name:"Hooks Library",price:"Free",description:"24 production-ready hooks across 6 categories. Drop in, configure, ship.",features:["Quality hooks: linting, testing, secrets detection","Safety hooks: damage control, backup, force-push guard","Integration hooks: Slack, Telegram, Linear, Obsidian","AI hooks: context preload, completion verify, cost tracking"],href:`https://edgelessai.gumroad.com/l/ztaflt?${u}`,badge:null}];d.PLOTTER.pieces,d.PLOTTER.factories,d.PLOTTER.factories,d.PLOTTER.factories,d.PLOTTER.pieces,d.PLOTTER.factories,d.PLOTTER.pieces,d.PLOTTER.best,d.PLOTTER.factories,d.PLOTTER.pieces,d.PLOTTER.kept,d.PLOTTER.kept,d.PLOTTER.factories,d.PLOTTER.pieces,d.PLOTTER.best,d.PLOTTER.kept;let m=[{slug:"real-cost-ai-agents-production-2026",editorial:!0,title:"The Real Cost of Running AI Agents in Production — A Monthly Breakdown (2026)",description:"Your AI agent costs 5–15× more in production than your prototype. Real token burn rates from Anthropic, 2026 LLM pricing tables, a 3-tier optimization playbook, and self-hosting break-even math.",date:"2026-05-06",tags:["AI Agents","LLM Pricing","Cost Optimization","Production"],readTime:"12 min",content:`
...
After the first week under this structure our open rate rose to thirty-four percent and we received twelve direct replies. The pipeline still runs automatically, but the output no longer reads like a database dump.
    `.trim()},{slug:"what-portland-businesses-need-from-ai",editorial:!0,title:"I Read 500 Google Reviews in Portland. Here's What Small Businesses Actually Need from AI.",description:"Dental offices losing patients to voicemail. HVAC companies quoting three days late. The AI solutions Portland small businesses need aren't chatbots. They're answering the phone.",date:"2026-05-05",tags:["AI Agents","Local Business","Voice AI","Portland"],readTime:"6 min",content:`
...
That's not a technology conversation. It's a business conversation. And it starts with reading the reviews.
    `.trim()},{slug:"pricing-ai-agent-services-solo-studio",editorial:!0,title:"How to Price AI Agent Services When Nobody Knows What They Cost",description:"I surveyed 20 agencies and freelancers offering AI agent builds. The range was $500 to $150,000. Here's the framework I use to price Edgeless Lab's services.",date:"2026-05-05",tags:["AI Agents","Pricing","Business","Solo Founder"],readTime:"6 min",content:`
...
The market will standardize eventually. Right now, the advantage goes to whoever can articulate the value clearly enough to justify the price. That's not a pricing problem. It's a positioning problem.
    `.trim()},{slug:"self-healing-ai-infrastructure",editorial:!0,title:"Half My AI Agents Were Dead. I Didn't Know for a Week.",description:"I discovered 10 of my 20 agents were ghosts — registered, visible in dashboards, producing nothing. Here's the five-layer self-healing system I built so it never happens again.",date:"2026-05-05",tags:["Multi-Agent","Infrastructure","Self-Healing","Monitoring"],readTime:"8 min",productSlug:"multi-agent-blueprint",ctaHook:"The monitoring scripts, escalation protocol, and healing patterns behind this post — ready to drop into your own agent infrastructure.",content:`
...
The best time to set up memory is before your next session. Takes 15 minutes, saves hours every week.
    `.trim()}];var g=e.i(60409);function f(e,t){g.default.capture("cta_clicked",{cta_name:e,destination:t})}var y=e.i(25062),w=e.i(63060);function v({text:e,font:s='300 18px "Geist"',lineHeight:o=30,className:r,style:n,fallback:l,cursorRadius:c=36,cursorColor:h="var(--accent)"}){let d=(0,a.useRef)(null),{ready:u,prepareWithSegments:p,layoutNextLine:m}=(0,i.usePreText)("Geist");return((0,a.useEffect)(()=>{if(!u||!p||!m||!d.current)return;let t=d.current,a=p(e,s);if(!a)return;let r=!1,n=0,i=0,l=0,g=0;for(;t.firstChild;)t.removeChild(t.firstChild);let f=[],y=document.createElement("div");function w(e){let s=t.clientWidth;if(0===s)return[];let r={segmentIndex:0,graphemeIndex:0},n=0,i=[],l=0;for(;l++<500;){let t=s,l=0;if(e&&n+o>e.y&&n<e.y+e.height){let a=e.x,o=e.x+e.width;if(a<=0)t=s-(l=Math.max(0,o+12));else if(o>=s)t=Math.max(60,a-12);else{let e=a-12,r=s-o-12;e>=r?t=Math.max(60,e):(l=o+12,t=Math.max(60,r))}}t=Math.max(t,60);let c=r.segmentIndex,h=r.graphemeIndex,d=m(a,r,t);if(!d||(i.push({text:d.text.trimEnd(),y:n,indent:l}),r=d.end,n+=o,r.segmentIndex===c&&r.graphemeIndex===h))break}return i}function v(e){for(var a=e.length;f.length<a;){let e=document.createElement("div");e.style.cssText=`
      ...
      z-index: 1;
    `,t.appendChild(y);let b=w(null);g=b.length*o,v(b);for(let e=0;e<f.length;e++)f[e].style.opacity="0",f[e].style.transition="opacity 0.4s ease, transform 0.35s cubic-bezier(0.16, 1, 0.3, 1)";function k(){r=!0,y.style.opacity="0.15",l||A()}function x(e){let a=t.getBoundingClientRect();n=e.clientX-a.left,i=e.clientY-a.top,y.style.transform=`translate(${n-c}px, ${i-c}px)`,r||(r=!0,y.style.opacity="0.15",l||A())}function T(){r=!1,y.style.opacity="0",setTimeout(()=>{r||v(w(null))},300)}function A(){if(!r){l=0;return}l=requestAnimationFrame(A),v(w({x:n-c-14,y:i-c-14,width:(c+14)*2,height:(c+14)*2}))}return requestAnimationFrame(()=>{for(let e=0;e<b.length;e++)setTimeout(()=>{f[e]&&(f[e].style.opacity="1")},80*e)}),t.style.cursor="crosshair",t.addEventListener("pointerenter",k),t.addEventListener("pointermove",x),t.addEventListener("pointerleave",T),()=>{cancelAnimationFrame(l),t.removeEventListener("pointerenter",k),t.removeEventListener("pointermove",x),t.removeEventListener("pointerleave",T)}},[u,e,s,o,p,m,c,h]),u)?(0,t.jsx)("div",{ref:d,className:r,style:{...n,position:"relative",overflow:"visible"}}):(0,t.jsx)("div",{ref:d,className:r,style:n,children:l??e})}let b="One developer shipping autonomous agents, MCP servers, and generative art. 18 products, all free. Everything open source.";function k(){return(0,t.jsx)("div",{className:"absolute -top-20 -right-20 w-96 h-96 opacity-30 pointer-events-none",children:(0,t.jsxs)("svg",{viewBox:"0 0 400 400",className:"w-full h-full animate-spin",style:{animationDuration:"60s"},children:[(0,t.jsx)("defs",{children:(0,t.jsxs)("linearGradient",{id:"swarmGrad",x1:"0%",y1:"0%",x2:"100%",y2:"100%",children:[(0,t.jsx)("stop",{offset:"0%",stopColor:"rgba(129, 140, 248, 0.3)"}),(0,t.jsx)("stop",{offset:"50%",stopColor:"rgba(52, 211, 153, 0.2)"}),(0,t.jsx)("stop",{offset:"100%",stopColor:"rgba(129, 140, 248, 0.1)"})]})}),[180,140,100,60].map((e,a)=>(0,t.jsx)("polygon",{points:Array.from({length:6},(t,a)=>{let s=Math.PI/3*a-Math.PI/2,o=200+e*Math.cos(s),r=200+e*Math.sin(s);return`${o},${r}`}).join(" "),fill:"none",stroke:"url(#swarmGrad)",strokeWidth:.5+.3*a,opacity:.3+.15*a,style:{animation:`pulse ${4+a}s ease-in-out infinite`,animationDelay:`${.5*a}s`}},a)),Array.from({length:7},(e,a)=>{let s=2*Math.PI*a/7;return(0,t.jsx)("circle",{cx:200+20*Math.cos(s),cy:200+20*Math.sin(s),r:3,fill:"rgba(129, 140, 248, 0.6)",style:{animation:"pulse 2s ease-in-out infinite",animationDelay:`${.2*a}s`}},a)})]})})}function x(){let e=[...m].sort((e,t)=>new Date(t.date).getTime()-new Date(e.date).getTime()).slice(0,8);return(0,t.jsx)("ul",{className:"divide-y",style:{borderColor:"var(--border-subtle)"},children:e.map((e,a)=>{let o,r,n=!!e.isLaunch;return(0,t.jsx)("li",{style:{borderColor:"var(--border-subtle)",animation:`fadeInUp 0.4s cubic-bezier(0.16,1,0.3,1) ${.05*a}s both`},className:"border-b first:border-t",children:(0,t.jsxs)(s.default,{href:`/blog/${e.slug}`,className:"group grid grid-cols-[auto_auto_1fr_auto] items-center gap-4 py-4 px-1 transition-colors",children:[(0,t.jsx)("span",{className:"text-[11px] font-mono tabular-nums shrink-0 w-[68px]",style:{color:"var(--text-tertiary)"},children:e.date.slice(5)}),(0,t.jsx)("span",{className:"text-[10px] font-mono uppercase tracking-[0.12em] px-2 py-0.5 rounded shrink-0",style:{background:n?"var(--accent-muted)":"var(--bg-surface)",color:n?"var(--accent)":"var(--text-tertiary)",border:"1px solid var(--border-subtle)"},children:n?"launch":"post"}),(0,t.jsx)("span",{className:"text-[14px] font-medium truncate transition-colors group-hover:text-white",style:{color:"var(--text-primary)"},children:e.title}),(0,t.jsx)("span",{className:"text-[11px] font-mono shrink-0 hidden sm:inline",style:{color:"var(--text-tertiary)"},children:(o=new Date(e.date).getTime(),(r=Math.floor((Date.now()-o)/864e5))<1?"today":1===r?"yesterday":r<30?`${r}d ago`:r<365?`${Math.floor(r/30)}mo ago`:`${Math.floor(r/365)}y ago`)})]})},e.slug)})})}function T({projects:e}){return(0,t.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-4 md:grid-rows-[auto_auto]",children:e.map((e,a)=>(0,t.jsx)("div",{className:e.span,children:(0,t.jsx)(n.GlowingCard,{className:"h-full",href:e.href,children:(0,t.jsxs)("div",{style:{animation:`fadeInUp 0.5s cubic-bezier(0.16,1,0.3,1) ${.1*a}s both`},children:[(0,t.jsxs)("div",{className:"w-full rounded-lg mb-6 overflow-hidden",style:{background:"rgba(0,0,0,0.4)",border:"1px solid var(--border-subtle)"},children:[(0,t.jsxs)("div",{className:"flex items-center gap-1.5 px-3 py-2.5 border-b",style:{borderColor:"var(--border-subtle)"},children:[(0,t.jsx)("div",{className:"w-2 h-2 rounded-full",style:{background:"rgba(255,255,255,0.1)"}}),(0,t.jsx)("div",{className:"w-2 h-2 rounded-full",style:{background:"rgba(255,255,255,0.1)"}}),(0,t.jsx)("div",{className:"w-2 h-2 rounded-full",style:{background:"rgba(255,255,255,0.1)"}}),(0,t.jsx)("span",{className:"ml-2 text-xs font-mono",style:{color:"var(--text-tertiary)"},children:e.title.toLowerCase().replace(/\s+/g,"-")})]}),(0,t.jsx)("pre",{className:`px-3 py-3 text-xs leading-[1.7] font-mono whitespace-pre overflow-hidden ${0===a?"min-h-[120px]":"min-h-[80px]"}`,style:{color:"var(--green)"},children:e.snippet})]}),(0,t.jsx)("div",{className:"flex items-start justify-between gap-4",children:(0,t.jsxs)("div",{children:[(0,t.jsx)("h3",{className:"text-lg font-semibold mb-1.5",style:{color:"var(--text-primary)"},children:e.title}),(0,t.jsx)("p",{className:"text-sm max-w-md",style:{color:"var(--text-secondary)",lineHeight:1.6},children:e.description})]})}),(0,t.jsx)("div",{className:"flex flex-wrap gap-2 mt-4",children:e.tags.map(e=>(0,t.jsx)("span",{className:"px-2.5 py-1 text-xs font-mono rounded-md",style:{background:"var(--accent-muted)",color:"var(--accent)"},children:e},e))})]})})},e.title))})}function A({capabilities:e}){return(0,t.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-4",children:e.map((e,a)=>(0,t.jsxs)("div",{className:"rounded-xl border overflow-hidden",style:{background:"var(--bg-base)",borderColor:"var(--border-subtle)",animation:`fadeInUp 0.4s cubic-bezier(0.16,1,0.3,1) ${.08*a}s both`},children:[(0,t.jsxs)("div",{className:"px-5 py-3 border-b flex items-center justify-between",style:{borderColor:"var(--border-subtle)"},children:[(0,t.jsx)("span",{className:"text-xs font-mono",style:{color:"var(--text-secondary)"},children:e.label}),(0,t.jsx)("span",{className:"w-1.5 h-1.5 rounded-full",style:{background:"var(--green)"}})]}),(0,t.jsx)("pre",{className:"px-5 py-4 text-xs leading-[1.8] font-mono whitespace-pre overflow-x-auto",style:{color:"var(--green)"},children:e.snippet})]},e.label))})}let I='300 14px "Geist"';function C({nodes:e}){let s=(0,a.useMemo)(()=>(function(e){let t=[];for(let a=0;a<e.length;a++){let s=e[a];t.push({text:s.label,font:'600 14px "Geist Mono"',lineHeight:28,style:{color:"var(--accent)"}}),t.push({text:`\u00A0${s.sublabel}`,font:I,lineHeight:28,style:{color:"var(--text-tertiary)"}}),a<e.length-1&&t.push({text:" → ",font:I,lineHeight:28,style:{color:"var(--border-focus)"}})}return t})(e),[e]);return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)("div",{className:"max-w-2xl",children:(0,t.jsx)(c,{segments:s,style:{color:"var(--text-tertiary)"}})}),(0,t.jsx)("div",{className:"mt-8 max-w-2xl",children:(0,t.jsx)(h,{text:"Agents call tools through MCP. Knowledge persists across sessions in vector memory and markdown vaults. A single VPS keeps the whole system running, unattended. Every tool is an MCP server. Every agent can use any tool. Add a new capability and it's immediately available to every agent in the system.",font:'300 14px "Geist"',lineHeight:24,orbCount:3,orbRadius:36,textColor:"var(--text-tertiary)"})})]})}function S({experiments:e}){return(0,t.jsx)("div",{className:"grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4",children:e.map((e,a)=>(0,t.jsxs)("a",{href:e.href,...e.external?{target:"_blank",rel:"noopener noreferrer"}:{},className:"group relative rounded-xl border p-5 transition-all hover:scale-[1.02] flex flex-col",style:{background:"var(--bg-surface)",borderColor:"var(--border-subtle)",animation:`fadeInUp 0.4s cubic-bezier(0.16,1,0.3,1) ${.08*a}s both`},children:[(0,t.jsxs)("div",{className:"flex items-center justify-between mb-3",children:[(0,t.jsx)("span",{className:"text-xs font-mono uppercase tracking-[0.12em]",style:{color:"var(--accent)"},children:e.category}),e.status&&(0,t.jsx)("span",{className:"text-[10px] font-mono uppercase tracking-[0.1em] px-1.5 py-0.5 rounded",style:{background:"Live"===e.status?"var(--green-muted)":"var(--accent-muted)",color:"Live"===e.status?"var(--green)":"var(--accent)"},children:e.status})]}),(0,t.jsx)("span",{className:"text-sm font-medium block mb-2",style:{color:"var(--text-primary)"},children:e.title}),e.description&&(0,t.jsx)("p",{className:"text-xs line-clamp-2 mb-3 flex-1",style:{color:"var(--text-tertiary)",lineHeight:1.6},children:e.description}),e.stack&&e.stack.length>0&&(0,t.jsx)("div",{className:"flex flex-wrap gap-1.5 mt-auto",children:e.stack.map(e=>(0,t.jsx)("span",{className:"text-[10px] font-mono px-1.5 py-0.5 rounded",style:{background:"rgba(255,255,255,0.05)",color:"var(--text-tertiary)"},children:e},e))}),(0,t.jsx)("div",{className:"absolute top-5 right-5 opacity-0 group-hover:opacity-100 transition-opacity",style:{color:"var(--text-tertiary)"},children:(0,t.jsx)(r.ArrowUpRight,{size:14})})]},e.title))})}function P(){let e=p.filter(e=>"Free"!==e.price).slice(0,6),a=p.find(e=>"Free"===e.price),n=p.length-e.length-!!a;return(0,t.jsxs)("div",{className:"grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3",children:[e.map((e,a)=>(0,t.jsxs)("a",{href:e.href,target:"_blank",rel:"noopener noreferrer",className:"group block rounded-xl border p-5 transition-all hover:scale-[1.01] hover:border-white/20",style:{background:"var(--bg-surface)",borderColor:"var(--border-subtle)",animation:`fadeInUp 0.4s cubic-bezier(0.16,1,0.3,1) ${.08*a}s both`},children:[(0,t.jsxs)("div",{className:"flex items-center justify-between mb-2",children:[(0,t.jsx)("span",{className:"text-sm font-semibold",style:{color:"var(--text-primary)"},children:e.name}),(0,t.jsx)(r.ArrowUpRight,{size:14,className:"opacity-0 group-hover:opacity-100 transition-opacity",style:{color:"var(--text-tertiary)"}})]}),(0,t.jsx)("span",{className:"text-lg font-bold font-mono block mb-2",style:{color:"var(--accent)"},children:e.price}),(0,t.jsx)("p",{className:"text-xs",style:{color:"var(--text-tertiary)",lineHeight:1.6},children:e.description})]},e.name)),a&&(0,t.jsxs)(s.default,{href:"/products/",className:"group block rounded-xl border p-5 transition-all hover:scale-[1.01] hover:border-white/20",style:{background:"var(--bg-surface)",borderColor:"var(--border-subtle)",animation:"fadeInUp 0.4s cubic-bezier(0.16,1,0.3,1) 0.24s both"},children:[(0,t.jsxs)("div",{className:"flex items-center justify-between mb-2",children:[(0,t.jsx)("span",{className:"text-sm font-semibold",style:{color:"var(--text-primary)"},children:a.name}),(0,t.jsx)("span",{className:"text-xs font-mono px-2 py-0.5 rounded-md",style:{background:"rgba(34,197,94,0.15)",color:"var(--green)"},children:"Free"})]}),(0,t.jsx)("p",{className:"text-xs mb-3",style:{color:"var(--text-tertiary)",lineHeight:1.6},children:a.description}),(0,t.jsxs)("span",{className:"text-xs font-medium flex items-center gap-1",style:{color:"var(--accent)"},children:["+",n," more products ",(0,t.jsx)(o.ArrowRight,{size:12})]})]})]})}function M(){let e=(0,a.useRef)(null),[r,n]=(0,a.useState)(0);(0,a.useEffect)(()=>{if(!e.current)return;let t=()=>{e.current&&n(e.current.clientWidth)};t();let a=new ResizeObserver(t);return a.observe(e.current),()=>a.disconnect()},[]);let l=function(e,t,s){let{ready:o,prepare:r,layout:n,prepareWithSegments:l,walkLineRanges:c}=(0,i.usePreText)("Geist"),[h,d]=(0,a.useState)(null),u=(0,a.useRef)(""),p=(0,a.useCallback)(()=>{if(!o||!r||!n||!l||!c||s<=0)return;let a=`${e}::${t}::42::${s}`;if(a===u.current)return;u.current=a;let i=r(e,t);if(!i)return;let h=n(i,s,42);if(!h||h.lineCount<=1){let a=l(e,t);if(!a)return;let o=0;c(a,s,e=>{e.width>o&&(o=e.width)}),d(Math.ceil(o));return}let p=l(e,t);if(!p)return;let m=0;c(p,s,e=>{e.width>m&&(m=e.width)});let g=Math.ceil(m),f=n(i,g,42);if(f&&f.lineCount>h.lineCount)for(;g<s;){let e=n(i,++g,42);if(e&&e.lineCount<=h.lineCount)break}d(g)},[o,e,t,42,s,r,n,l,c]);return(0,a.useEffect)(()=>{p()},[p]),h}("One person shipping agents, MCP servers, generative art, and developer tools. In production, in the open, since day one. No pitch decks. No vaporware.",'300 28px "Geist"',r);return(0,t.jsxs)("div",{className:"max-w-2xl",ref:e,children:[(0,t.jsxs)("p",{className:"text-2xl sm:text-3xl font-light leading-[1.5]",style:{color:"var(--text-secondary)",animation:"fadeInUp 0.6s cubic-bezier(0.16,1,0.3,1) both",...l?{maxWidth:`${l}px`}:{}},children:[(0,t.jsx)("span",{style:{color:"var(--text-primary)"},children:"One person"})," shipping agents, MCP servers, generative art, and developer tools. In production, in the open, since day one."," ",(0,t.jsx)("span",{style:{color:"var(--text-primary)"},children:"No pitch decks. No vaporware."})]}),(0,t.jsx)("div",{className:"mt-8",style:{animation:"fadeInUp 0.4s cubic-bezier(0.16,1,0.3,1) 0.2s both"},children:(0,t.jsxs)(s.default,{href:"/about",className:"text-sm font-medium flex items-center gap-1.5 transition-colors hover:text-white",style:{color:"var(--accent)"},children:["About the lab ",(0,t.jsx)(o.ArrowRight,{size:14})]})})]})}function j(){return(0,t.jsx)("section",{className:"px-6 py-20 border-t",style:{borderColor:"var(--border-subtle)"},children:(0,t.jsx)("div",{className:"max-w-[1280px] mx-auto",children:(0,t.jsx)("div",{className:"max-w-lg",children:(0,t.jsxs)("div",{style:{animation:"fadeInUp 0.4s cubic-bezier(0.16,1,0.3,1) both"},children:[(0,t.jsxs)("div",{className:"flex items-center gap-2 mb-4",children:[(0,t.jsx)("span",{className:"w-1.5 h-1.5 rounded-full",style:{background:"var(--green)"}}),(0,t.jsx)("span",{className:"text-xs font-mono",style:{color:"var(--text-tertiary)"},children:"Stay in the loop"})]}),(0,t.jsx)("h2",{className:"text-2xl font-semibold tracking-tight mb-2",style:{color:"var(--text-primary)"},children:"Everything ships on GitHub."}),(0,t.jsx)("p",{className:"text-sm mb-6",style:{color:"var(--text-secondary)",lineHeight:1.7},children:"Agent frameworks, generative art, and developer tools - all in the open."}),(0,t.jsxs)("a",{href:"https://github.com/edgeless-ai",target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center gap-2 h-11 px-6 text-sm font-medium text-white rounded-full transition-all hover:brightness-110 hover:scale-[1.02]",style:{background:"var(--accent)"},children:["GitHub ",(0,t.jsx)(r.ArrowUpRight,{size:14})]})]})})})})}e.s(["AboutBlurb",0,M,"CapabilitiesGrid",0,A,"ExperimentsGrid",0,S,"FeaturedGrid",0,T,"ProductHighlight",0,P,"RecentActivity",0,x,"StackFlow",0,C,"SubscribeSection",0,j],20811),e.i(20811),e.s(["AboutBlurb",0,M,"CapabilitiesGrid",0,A,"ExperimentsGrid",0,S,"FeaturedGrid",0,T,"HeroSection",0,function(){let e=function(e=50){let t=(0,a.useRef)(null),s=(0,a.useRef)([]),o=(0,a.useRef)({x:0,y:0}),r=(0,a.useRef)(0);return(0,a.useEffect)(()=>{let a=t.current;if(!a)return;let n=a.getContext("2d");if(!n)return;let i=()=>{a.width=a.offsetWidth*window.devicePixelRatio,a.height=a.offsetHeight*window.devicePixelRatio,n.scale(window.devicePixelRatio,window.devicePixelRatio)};i(),window.addEventListener("resize",i),s.current=Array.from({length:e},()=>({x:Math.random()*a.offsetWidth,y:Math.random()*a.offsetHeight,vx:(Math.random()-.5)*.5,vy:(Math.random()-.5)*.5,size:1+2*Math.random(),opacity:.1+.4*Math.random(),pulse:Math.random()*Math.PI*2}));let l=e=>{let t=a.getBoundingClientRect();o.current={x:e.clientX-t.left,y:e.clientY-t.top}};a.addEventListener("mousemove",l);let c=0,h=()=>{c++;let e=a.offsetWidth,t=a.offsetHeight,i=o.current;n.clearRect(0,0,e,t),s.current.forEach((a,o)=>{a.x+=a.vx,a.y+=a.vy;let r=i.x-a.x,l=i.y-a.y,h=Math.sqrt(r*r+l*l);h<200&&h>0&&(a.vx+=r/h*.01,a.vy+=l/h*.01),a.vx*=.99,a.vy*=.99,a.x<0&&(a.x=e),a.x>e&&(a.x=0),a.y<0&&(a.y=t),a.y>t&&(a.y=0),a.pulse+=.02;let d=a.opacity*(.8+.2*Math.sin(a.pulse));n.beginPath(),n.arc(a.x,a.y,a.size,0,2*Math.PI),n.fillStyle=`rgba(129, 140, 248, ${d})`,n.fill(),c%3==0&&o%2==0&&s.current.slice(o+1).forEach(e=>{let t=a.x-e.x,s=a.y-e.y,o=Math.sqrt(t*t+s*s);o<100&&(n.beginPath(),n.moveTo(a.x,a.y),n.lineTo(e.x,e.y),n.strokeStyle=`rgba(129, 140, 248, ${.1*(1-o/100)})`,n.lineWidth=.5,n.stroke())})}),r.current=requestAnimationFrame(h)};return h(),()=>{window.removeEventListener("resize",i),a.removeEventListener("mousemove",l),cancelAnimationFrame(r.current)}},[e]),t}(60),[n,i]=(0,a.useState)(!1);return(0,a.useEffect)(()=>{i(!0)},[]),(0,t.jsxs)("section",{className:"relative min-h-[100svh] flex items-center overflow-hidden",children:[(0,t.jsx)("div",{className:"absolute inset-0 hero-gradient opacity-60"}),(0,t.jsx)("canvas",{ref:e,className:"absolute inset-0 w-full h-full pointer-events-auto",style:{opacity:.8}}),(0,t.jsx)(k,{}),(0,t.jsx)("div",{className:"absolute inset-0 pointer-events-none",style:{background:"radial-gradient(ellipse 80% 50% at 50% 100%, transparent 0%, var(--color-bg-base) 100%)"}}),(0,t.jsx)("div",{className:"relative z-10 w-full max-w-[1400px] mx-auto px-6 py-32 md:py-40",children:(0,t.jsxs)("div",{className:"grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-12 lg:gap-8 items-center",children:[(0,t.jsxs)("div",{className:"space-y-8",children:[(0,t.jsx)(y.AnimatedFadeIn,{children:(0,t.jsxs)("div",{className:"inline-flex items-center gap-2.5 px-4 py-2 rounded-full border w-fit",style:{borderColor:"rgba(52, 211, 153, 0.3)",background:"linear-gradient(135deg, rgba(52, 211, 153, 0.1), rgba(52, 211, 153, 0.05))",boxShadow:"0 0 20px rgba(52, 211, 153, 0.15), inset 0 1px 0 rgba(255,255,255,0.1)"},children:[(0,t.jsxs)("span",{className:"relative flex h-2.5 w-2.5",children:[(0,t.jsx)("span",{className:"absolute inline-flex h-full w-full rounded-full opacity-75 animate-ping",style:{background:"var(--color-success)",animationDuration:"2s"}}),(0,t.jsx)("span",{className:"relative inline-flex h-2.5 w-2.5 rounded-full",style:{background:"var(--color-success)"}})]}),(0,t.jsx)("span",{className:"text-xs font-mono uppercase tracking-[0.14em]",style:{color:"var(--color-success)"},children:"Shipping daily"}),(0,t.jsx)("span",{style:{color:"var(--color-text-muted)"},children:"·"}),(0,t.jsx)("span",{style:{color:"var(--color-text-tertiary)"},children:"Live now"})]})}),(0,t.jsxs)("div",{className:"space-y-2",children:[(0,t.jsxs)("h1",{className:"text-[clamp(2.5rem,10vw,7rem)] font-bold leading-[0.9] tracking-[-0.04em]",style:{color:"var(--color-text-primary)"},children:[(0,t.jsx)(y.AnimatedText,{text:"Built",delay:.1}),(0,t.jsx)("span",{style:{color:"var(--color-text-tertiary)"},children:(0,t.jsx)(y.AnimatedText,{text:" solo",delay:.25})}),(0,t.jsx)("br",{}),(0,t.jsxs)("span",{className:"relative inline-block",style:{background:"linear-gradient(135deg, var(--color-accent-300), var(--color-accent-500))",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",backgroundClip:"text"},children:[(0,t.jsx)(y.AnimatedText,{text:"Shipped",delay:.4}),(0,t.jsx)("span",{className:"absolute -inset-4 blur-3xl opacity-30 -z-10",style:{background:"linear-gradient(135deg, var(--color-accent), var(--color-success))"}})]})," ",(0,t.jsx)(y.AnimatedText,{text:"open",delay:.55})]}),(0,t.jsx)("div",{className:"font-mono text-xs tracking-[0.2em] pt-2",style:{color:"var(--color-text-muted)"},children:(0,t.jsx)(y.AnimatedText,{text:"█████████████████████  SHIP · LEARN · REPEAT",delay:.7})})]}),(0,t.jsx)(y.AnimatedFadeIn,{delay:.8,children:(0,t.jsx)("div",{className:"max-w-xl",children:(0,t.jsx)(v,{text:b,font:'400 18px "Geist"',lineHeight:28,cursorRadius:40,cursorColor:"var(--color-accent)",className:"text-lg",style:{color:"var(--color-text-secondary)",lineHeight:1.6},fallback:(0,t.jsx)("p",{style:{lineHeight:1.6},children:b})})})}),(0,t.jsx)(y.AnimatedFadeIn,{delay:.95,children:(0,t.jsxs)("div",{className:"flex items-center gap-3 max-w-xl text-xs font-mono py-2 px-3 rounded-lg w-fit",style:{background:"var(--color-accent-subtle)",border:"1px solid var(--color-accent-muted)"},children:[(0,t.jsx)("span",{className:"px-2 py-0.5 rounded uppercase tracking-[0.12em] text-[10px]",style:{background:"var(--color-accent-muted)",color:"var(--color-accent)"},children:"Now"}),(0,t.jsxs)("span",{style:{color:"var(--color-text-secondary)"},children:["Shipping"," ",(0,t.jsx)(s.default,{href:"/products/launch-toolkit",className:"underline-offset-2 hover:underline transition-colors hover:text-white",style:{color:"var(--color-text-primary)"},children:"Digital Product Launch Toolkit"})," ","· 7 products in 7 days"]})]})}),(0,t.jsx)(y.AnimatedFadeIn,{delay:1,children:(0,t.jsxs)("div",{className:"flex flex-col sm:flex-row items-start sm:items-center gap-4 pt-4",children:[(0,t.jsxs)(s.default,{href:"/products",className:"group inline-flex items-center gap-2 h-12 px-7 text-sm font-medium text-white rounded-full transition-all hover:scale-[1.02] relative overflow-hidden",style:{background:"var(--color-accent)"},onClick:()=>f("hero_view_products","/products"),children:[(0,t.jsx)("span",{className:"relative z-10",children:"18 free products"}),(0,t.jsx)(o.ArrowRight,{size:16,className:"relative z-10 group-hover:translate-x-0.5 transition-transform"}),(0,t.jsx)("span",{className:"absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity",style:{background:"linear-gradient(135deg, var(--color-accent-300), var(--color-accent-500))"}})]}),(0,t.jsxs)(s.default,{href:"/projects",className:"inline-flex items-center gap-2 h-12 px-7 text-sm font-medium rounded-full border transition-all hover:scale-[1.02] hover:border-[var(--color-accent)]",style:{color:"var(--color-text-secondary)",borderColor:"var(--color-border-subtle)",background:"rgba(255,255,255,0.02)"},onClick:()=>f("hero_view_projects","/projects"),children:["See what's running",(0,t.jsx)(o.ArrowRight,{size:16})]}),(0,t.jsxs)("a",{href:"https://github.com/edgeless-ai",className:"inline-flex items-center gap-1.5 text-sm font-medium transition-colors hover:text-white px-3",style:{color:"var(--color-text-tertiary)"},children:["GitHub",(0,t.jsx)(r.ArrowUpRight,{size:14})]})]})}),(0,t.jsx)(y.AnimatedFadeIn,{delay:1.1,children:(0,t.jsxs)("div",{className:"flex items-center gap-8 pt-8 border-t",style:{borderColor:"var(--color-border-subtle)"},children:[(0,t.jsxs)("div",{children:[(0,t.jsx)("div",{className:"text-2xl font-bold tracking-tight",style:{color:"var(--color-text-primary)"},children:"18"}),(0,t.jsx)("div",{className:"text-xs font-mono uppercase tracking-[0.1em]",style:{color:"var(--color-text-tertiary)"},children:"Products"})]}),(0,t.jsxs)("div",{children:[(0,t.jsx)("div",{className:"text-2xl font-bold tracking-tight",style:{color:"var(--color-text-primary)"},children:"6"}),(0,t.jsx)("div",{className:"text-xs font-mono uppercase tracking-[0.1em]",style:{color:"var(--color-text-tertiary)"},children:"MCP Servers"})]}),(0,t.jsxs)("div",{children:[(0,t.jsx)("div",{className:"text-2xl font-bold tracking-tight",style:{color:"var(--color-text-primary)"},children:"75+"}),(0,t.jsx)("div",{className:"text-xs font-mono uppercase tracking-[0.1em]",style:{color:"var(--color-text-tertiary)"},children:"AI Skills"})]})]})})]}),(0,t.jsx)(y.AnimatedFadeIn,{delay:.5,className:"hidden lg:block",children:(0,t.jsxs)("div",{className:"relative",children:[(0,t.jsx)("div",{className:"absolute -inset-8 blur-3xl opacity-40 -z-10",style:{background:"radial-gradient(circle at center, var(--color-accent-muted), transparent 70%)"}}),(0,t.jsx)(w.GenerativeAscii,{})]})})]})}),(0,t.jsxs)("div",{className:"absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 opacity-60",style:{animation:"bounce 2s infinite"},children:[(0,t.jsx)("span",{className:"text-[10px] font-mono uppercase tracking-[0.2em]",style:{color:"var(--color-text-muted)"},children:"Scroll"}),(0,t.jsx)("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",children:(0,t.jsx)("path",{d:"M12 5v14M19 12l-7 7-7-7",style:{color:"var(--color-text-muted)"}})})]})]})},"ProductHighlight",0,P,"RecentActivity",0,x,"StackFlow",0,C,"SubscribeSection",0,j],43875)},92141,e=>{"use strict";var t=e.i(74092),a=e.i(43041),s=e.i(63560),o=e.i(17222),r=e.i(29114),n=e.i(60592),i=e.i(42175);let l=(0,i.default)("git-branch",[["path",{d:"M15 6a9 9 0 0 0-9 9V3",key:"1cii5b"}],["circle",{cx:"18",cy:"6",r:"3",key:"1h7g24"}],["circle",{cx:"6",cy:"18",r:"3",key:"fqmcym"}]]),c=(0,i.default)("git-commit-horizontal",[["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}],["line",{x1:"3",x2:"9",y1:"12",y2:"12",key:"1dyftd"}],["line",{x1:"15",x2:"21",y1:"12",y2:"12",key:"oup4p8"}]]),h=(0,i.default)("activity",[["path",{d:"M22 12h-2.48a2 2 0 0 0-1.93 1.46l-2.35 8.36a.25.25 0 0 1-.48 0L9.24 2.18a.25.25 0 0 0-.48 0l-2.35 8.36A2 2 0 0 1 4.49 12H2",key:"169zse"}]]);var d=e.i(91001),u=e.i(25062);function p({project:e}){let a={Live:{bg:"rgba(34,197,94,0.1)",color:"#22c55e"},Active:{bg:"rgba(129,140,248,0.1)",color:"#818cf8"},Draft:{bg:"rgba(156,163,175,0.1)",color:"#9ca3af"},Archived:{bg:"rgba(107,114,128,0.1)",color:"#6b7280"}}[e.status];return(0,t.jsxs)(d.GlowingCard,{href:`/projects/${e.slug}`,className:"h-full group",children:[(0,t.jsxs)("div",{className:"flex items-center justify-between mb-4",children:[(0,t.jsxs)("div",{className:"inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-mono",style:{background:a.bg,color:a.color},children:[(0,t.jsx)("span",{className:"w-1.5 h-1.5 rounded-full",style:{background:a.color}}),e.status]}),e.agentUpdated&&(0,t.jsx)("span",{className:"text-[10px] font-mono uppercase tracking-[0.1em] px-2 py-0.5 rounded",style:{background:"var(--color-accent-subtle)",color:"var(--color-accent)"},children:"Agent"})]}),(0,t.jsx)("h3",{className:"text-lg font-semibold mb-2 group-hover:text-white transition-colors",style:{color:"var(--color-text-primary)"},children:e.title}),(0,t.jsx)("p",{className:"text-sm mb-4 line-clamp-2",style:{color:"var(--color-text-secondary)"},children:e.description}),(0,t.jsxs)("div",{className:"flex items-center gap-3 mb-4",children:[void 0!==e.commitCount&&(0,t.jsxs)("span",{className:"flex items-center gap-1 text-xs font-mono",style:{color:"var(--color-text-muted)"},children:[(0,t.jsx)(c,{size:12}),e.commitCount," commits"]}),(0,t.jsxs)("span",{className:"flex items-center gap-1 text-xs font-mono",style:{color:"var(--color-text-muted)"},children:[(0,t.jsx)(l,{size:12}),e.category]})]}),(0,t.jsx)("div",{className:"flex flex-wrap gap-1.5",children:e.tags.slice(0,3).map(e=>(0,t.jsx)("span",{className:"px-2 py-0.5 text-[11px] font-mono rounded",style:{background:"var(--color-bg-surface)",color:"var(--color-text-tertiary)"},children:e},e))}),(0,t.jsx)("div",{className:"mt-4 flex items-center justify-end",children:(0,t.jsx)(r.ArrowUpRight,{size:16,className:"opacity-0 group-hover:opacity-100 transition-opacity",style:{color:"var(--color-text-muted)"}})})]})}e.s(["LiveProjectsShowcase",0,function(){let[e,r]=(0,a.useState)(null),[i,l]=(0,a.useState)(!0);if((0,a.useEffect)(()=>{(async()=>{try{let e=await fetch("/api/projects/live",{cache:"no-store"});if(e.ok){let t=await e.json();r({...t,source:"live"})}else throw Error("API unavailable")}catch{r({projects:[{slug:"safety-hooks",title:"Safety Hooks",description:"Production guardrails preventing destructive agent actions. 0 incidents.",tags:["Python","Safety","Claude Code"],category:"Infrastructure",status:"Live",agentUpdated:!0},{slug:"mcp-servers",title:"MCP Servers",description:"ChromaDB, knowledge search, multi-agent orchestration. Effect-TS.",tags:["MCP","TypeScript","ChromaDB"],category:"Infrastructure",status:"Live",agentUpdated:!0},{slug:"pen-plotter-art",title:"Pen Plotter Art",description:"Generative art with AI scoring. SVG to physical media pipeline.",tags:["Generative Art","Python","AxiDraw"],category:"Creative",status:"Active",agentUpdated:!1}],lastSync:new Date().toISOString(),source:"static"})}finally{l(!1)}})()},[]),i)return(0,t.jsx)("div",{className:"flex items-center justify-center h-64",children:(0,t.jsx)(n.RefreshCw,{className:"animate-spin",style:{color:"var(--color-accent)"}})});let c=e?.projects.slice(0,3)||[];return(0,t.jsx)("section",{className:"py-20 px-6",style:{background:"var(--color-bg-elevated)"},children:(0,t.jsxs)("div",{className:"max-w-[1400px] mx-auto",children:[(0,t.jsx)(u.AnimatedFadeIn,{children:(0,t.jsxs)("div",{className:"flex items-end justify-between mb-12",children:[(0,t.jsxs)("div",{children:[(0,t.jsxs)("div",{className:"inline-flex items-center gap-2 px-3 py-1.5 rounded-full border mb-4",style:{borderColor:"var(--color-accent-muted)",background:"var(--color-accent-subtle)"},children:[(0,t.jsx)(h,{size:14,style:{color:"var(--color-accent)"}}),(0,t.jsx)("span",{className:"text-xs font-mono uppercase tracking-[0.12em]",style:{color:"var(--color-accent)"},children:e?.source==="live"?"Live Sync":"Agent Updated"})]}),(0,t.jsx)("h2",{className:"text-[clamp(2rem,5vw,3rem)] font-bold tracking-[-0.03em]",style:{color:"var(--color-text-primary)"},children:"Projects in Production"}),(0,t.jsx)("p",{className:"mt-2 text-lg max-w-xl",style:{color:"var(--color-text-secondary)"},children:"Always-on systems. Agents ship updates automatically via Paperclip API."})]}),(0,t.jsxs)(s.default,{href:"/projects",className:"hidden sm:inline-flex items-center gap-2 text-sm font-medium transition-colors hover:text-white",style:{color:"var(--color-accent)"},children:["View all 6 projects ",(0,t.jsx)(o.ArrowRight,{size:16})]})]})}),(0,t.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-5",children:c.map((e,a)=>(0,t.jsx)(u.AnimatedFadeIn,{delay:.1+.1*a,children:(0,t.jsx)(p,{project:e})},e.slug))}),(0,t.jsx)(u.AnimatedFadeIn,{delay:.4,children:(0,t.jsxs)("div",{className:"mt-10 flex items-center justify-between pt-6 border-t",style:{borderColor:"var(--color-border-subtle)"},children:[(0,t.jsxs)("div",{className:"flex items-center gap-4 text-xs font-mono",style:{color:"var(--color-text-tertiary)"},children:[(0,t.jsxs)("span",{className:"flex items-center gap-1.5",children:[(0,t.jsx)("span",{className:"w-1.5 h-1.5 rounded-full bg-green-500 animate-pulse"}),e?.projects.length||0," projects tracked"]}),(0,t.jsx)("span",{className:"hidden sm:inline",children:"·"}),(0,t.jsxs)("span",{className:"hidden sm:inline",children:["Last sync: ",new Date(e?.lastSync||Date.now()).toLocaleTimeString()]})]}),(0,t.jsxs)(s.default,{href:"/projects",className:"sm:hidden inline-flex items-center gap-2 text-sm font-medium",style:{color:"var(--color-accent)"},children:["All projects ",(0,t.jsx)(o.ArrowRight,{size:16})]})]})})]})})}],92141)},60377,e=>{"use strict";var t=e.i(74092),a=e.i(43041);e.s(["ScrollReveal",0,function({children:e,className:s="",delay:o=0}){let[r,n]=function(e=.15){let t=(0,a.useRef)(null),[s,o]=(0,a.useState)(!1);return(0,a.useEffect)(()=>{let a=t.current;if(!a)return;if(window.matchMedia("(prefers-reduced-motion: reduce)").matches)return void o(!0);let s=new IntersectionObserver(([e])=>{e.isIntersecting&&(o(!0),s.disconnect())},{threshold:e});return s.observe(a),()=>s.disconnect()},[e]),[t,s]}(.12);return(0,t.jsx)("div",{ref:r,className:s,style:{opacity:+!!n,transform:n?"translateY(0)":"translateY(24px)",transition:`opacity 0.6s cubic-bezier(0.16, 1, 0.3, 1) ${o}s, transform 0.6s cubic-bezier(0.16, 1, 0.3, 1) ${o}s`},children:e})}],60377)}]);