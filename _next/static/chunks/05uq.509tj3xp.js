(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,43875,e=>{"use strict";var t=e.i(74092),a=e.i(43041),s=e.i(63560);let r=(0,e.i(42175).default)("arrow-right",[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"m12 5 7 7-7 7",key:"xquz4c"}]]);var o=e.i(29114),n=e.i(60409);function i(e,t){n.default.capture("cta_clicked",{cta_name:e,destination:t})}function l({text:e,className:a,delay:s=0}){let r=e.split(" ");return(0,t.jsxs)("span",{className:a,children:[r.map((e,a)=>(0,t.jsx)("span",{className:"inline-block mr-[0.25em]",style:{animation:`fadeInUp 0.5s cubic-bezier(0.16,1,0.3,1) ${s+.08*a}s both`},children:e},a)),(0,t.jsx)("style",{children:`
      ...
      `})]})}var u=e.i(25);function p({text:e,font:s='300 18px "Geist"',lineHeight:r=30,className:o,style:n,fallback:i,cursorRadius:l=36,cursorColor:c="var(--accent)"}){let d=(0,a.useRef)(null),{ready:h,prepareWithSegments:m,layoutNextLine:g}=(0,u.usePreText)("Geist");return((0,a.useEffect)(()=>{if(!h||!m||!g||!d.current)return;let t=d.current,a=m(e,s);if(!a)return;let o=!1,n=0,i=0,u=0,p=0;for(;t.firstChild;)t.removeChild(t.firstChild);let f=[],y=document.createElement("div");function w(e){let s=t.clientWidth;if(0===s)return[];let o={segmentIndex:0,graphemeIndex:0},n=0,i=[],l=0;for(;l++<500;){let t=s,l=0;if(e&&n+r>e.y&&n<e.y+e.height){let a=e.x,r=e.x+e.width;if(a<=0)t=s-(l=Math.max(0,r+12));else if(r>=s)t=Math.max(60,a-12);else{let e=a-12,o=s-r-12;e>=o?t=Math.max(60,e):(l=r+12,t=Math.max(60,o))}}t=Math.max(t,60);let c=o.segmentIndex,d=o.graphemeIndex,h=g(a,o,t);if(!h||(i.push({text:h.text.trimEnd(),y:n,indent:l}),o=h.end,n+=r,o.segmentIndex===c&&o.graphemeIndex===d))break}return i}function b(e){for(var a=e.length;f.length<a;){let e=document.createElement("div");e.style.cssText=`
...
The best time to set up memory is before your next session. Takes 15 minutes, saves hours every week.
    `.trim()},{slug:"12-dollar-ai-operations-team",editorial:!0,title:"The $12/Week AI Operations Team",description:"How I replaced a $200K enterprise stack with multi-agent orchestration. The architecture, the economics, and the 10 agents that actually run my business.",date:"2026-04-17",tags:["AI Agents","Multi-Agent","Cost Optimization","Architecture"],readTime:"8 min",productSlug:"multi-agent-blueprint",ctaHook:"Complete orchestration blueprint with configs, scripts, and deployment guides. Deploy your own $12/week ops team.",content:`
