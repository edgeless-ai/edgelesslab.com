...
*Edgeless Lab builds infrastructure for autonomous AI systems. And sometimes, tools for watching them.*
    `.trim()},{slug:"envelope-protocol-multi-agent-coordination",editorial:!0,title:"We Built an Envelope Protocol to Stop Our AI Agents from Talking Forever",description:"Seven Discord bots needed to coordinate without infinite loops. A five-field envelope header and a depth counter solved it. Here's the protocol.",date:"2026-05-13",tags:["AI Agents","Multi-Agent Systems","Discord","Protocol Design"],readTime:"8 min",content:`
...
*Edgeless Lab builds infrastructure for autonomous AI systems.*
    `.trim()},{slug:"spend-breaker-circuit-breaker-llm-costs",editorial:!0,title:"A Circuit Breaker Saved Me $200 in Tokens. It Took 45 Minutes to Build.",description:"One of my AI agents consumed 60% of its daily token budget in four hours. The circuit breaker throttled it automatically. Here's the pattern.",date:"2026-05-13",tags:["AI Agents","Cost Management","Circuit Breaker","Infrastructure"],readTime:"7 min",content:`
...
*Edgeless Lab builds infrastructure for autonomous AI systems.*
    `.trim()},{slug:"generative-art-pen-plotter-pipeline",editorial:!0,title:"From Algorithm to Ink: How We Turn Generative Code into Physical Art",description:"65 algorithms, a texture pipeline, and a pen plotter. The toolchain that turns SVG code into framed prints on the wall.",date:"2026-05-13",tags:["Generative Art","Pen Plotting","Creative Coding","Design System"],readTime:"8 min",content:`
...
*Edgeless Lab builds infrastructure for autonomous AI systems. And occasionally, art.*
    `.trim()},{slug:"agents-that-improve-themselves",editorial:!0,title:"The Most Useful Thing Your AI Agents Can Do Is Audit Themselves",description:"We pointed our agents at our own knowledge base and asked what they should be doing that they weren't. Then we built the fixes.",date:"2026-05-12",tags:["AI Agents","Self-Improvement","Automation","Knowledge Management"],readTime:"7 min",content:`
...
*Edgeless Lab builds infrastructure for autonomous AI systems.*
    `.trim()},{slug:"youtube-mining-ai-agents",editorial:!0,title:"I Pointed 7 AI Agents at My YouTube History. They Found What I Couldn't See.",description:"7 agents analyzed 1,062 YouTube videos and found 14 things they should be doing that they weren't. Topic clusters, channel ROI, knowledge gaps, and the meta-move: agents auditing themselves.",date:"2026-05-12",tags:["AI Agents","YouTube","Knowledge Mining","Automation"],readTime:"10 min",content:`
...
The goal isn't to build the most complex system. It's to build the most useful one, with the least moving parts.
    `.trim()},{slug:"how-claude-code-memory-works",editorial:!0,title:"How Claude Code Memory Actually Works",description:"Claude forgets everything between sessions. File-based memory fixes that. The simplest setup, and why it changes how you work with AI.",date:"2026-03-21",tags:["Claude Code","Memory","Developer Tools"],readTime:"6 min",content:`
