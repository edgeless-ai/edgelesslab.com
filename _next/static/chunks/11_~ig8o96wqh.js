(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,43875,e=>{"use strict";var t=e.i(74092),a=e.i(43041),s=e.i(63560);let o=(0,e.i(42175).default)("arrow-right",[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"m12 5 7 7-7 7",key:"xquz4c"}]]);var r=e.i(29114),n=e.i(60409);function i(e,t){n.default.capture("cta_clicked",{cta_name:e,destination:t})}function l({text:e,className:a,delay:s=0}){let o=e.split(" ");return(0,t.jsxs)("span",{className:a,children:[o.map((e,a)=>(0,t.jsx)("span",{className:"inline-block mr-[0.25em]",style:{animation:`fadeInUp 0.5s cubic-bezier(0.16,1,0.3,1) ${s+.08*a}s both`},children:e},a)),(0,t.jsx)("style",{children:`
      ...
      `})]})}function h({children:e,className:a="",href:o,glowColor:r="var(--accent)"}){let n=(0,t.jsxs)("div",{className:`group relative overflow-hidden rounded-2xl border p-8 transition-all duration-200 hover:scale-[1.01] ${a}`,style:{background:"var(--bg-surface)",borderColor:"var(--border-subtle)"},children:[(0,t.jsx)("div",{className:"pointer-events-none absolute -inset-px rounded-2xl opacity-0 transition-opacity duration-300 group-hover:opacity-100",style:{background:`radial-gradient(600px circle at var(--mouse-x, 50%) var(--mouse-y, 50%), ${r}10, transparent 40%)`}}),(0,t.jsx)("div",{className:"pointer-events-none absolute inset-x-0 top-0 h-px opacity-0 transition-opacity duration-300 group-hover:opacity-100",style:{background:`linear-gradient(90deg, transparent, ${r}30, transparent)`}}),(0,t.jsx)("div",{className:"relative",children:e})]});return o?o.startsWith("/")?(0,t.jsx)(s.default,{href:o,children:n}):(0,t.jsx)("a",{href:o,target:"_blank",rel:"noopener noreferrer",children:n}):n}let d=["lorenz","rossler","spiral","flow"],u={lorenz:[129,140,248],rossler:[52,211,153],spiral:[167,139,250],flow:[96,165,250]};function p(){let e=(0,a.useRef)(null),s=(0,a.useRef)(0),o=(0,a.useRef)(null),r=(0,a.useCallback)(e=>{var t;let a=(Date.now()^0xffffffff*Math.random())>>>0,s=(t=a,()=>{t|=0;let e=Math.imul((t=t+0x6d2b79f5|0)^t>>>15,1|t);return(((e=e+Math.imul(e^e>>>7,61|e)^e)^e>>>14)>>>0)/0x100000000}),r=d[Math.floor(s()*d.length)],n=e.width,i=e.height;o.current={particles:Array.from({length:250},()=>({x:s()*n,y:s()*i,vx:(s()-.5)*1.5,vy:(s()-.5)*1.5,life:Math.floor(200*s())+100,maxLife:300})),type:r,seed:a,rng:s,cx1:n*(.3+.4*s()),cy1:i*(.3+.4*s()),cx2:n*(.3+.4*s()),cy2:i*(.3+.4*s()),strength:.015+.02*s()}},[]);return(0,a.useEffect)(()=>{let t=e.current;if(!t)return;let a=t.getContext("2d");if(!a)return;let n=()=>{let e=Math.min(window.devicePixelRatio||1,2),s=t.getBoundingClientRect();t.width=s.width*e,t.height=s.height*e,a.scale(e,e),r(t)};n();let i=()=>{let e=o.current;if(!e||!t)return;let r=t.getBoundingClientRect().width,n=t.getBoundingClientRect().height,l=u[e.type];for(let s of(a.fillStyle="rgba(0, 0, 0, 0.04)",a.fillRect(0,0,r,n),e.particles)){!function(e,t,a,s,o,r,n,i,l,c,h){let d=0,u=0;switch(t){case"lorenz":{let t=a-e.x,i=s-e.y,l=o-e.x,c=r-e.y,h=Math.sqrt(t*t+i*i)+1,p=Math.sqrt(l*l+c*c)+1;d=(t/h-c/p)*n,u=(i/h+l/p)*n;break}case"rossler":{let t=a-e.x,o=s-e.y,r=Math.sqrt(t*t+o*o)+1;d=(-o/r+.008*t)*n,u=(t/r+.008*o)*n;break}case"spiral":{let t=a-e.x,o=s-e.y,r=Math.sqrt(t*t+o*o)+1,i=Math.atan2(o,t)+.4;d=Math.cos(i)/r*n*8,u=Math.sin(i)/r*n*8;break}case"flow":d=Math.sin(.003*e.y+.01*i)*n*.8,u=Math.cos(.003*e.x+.01*i)*n*.8}e.vx+=d,e.vy+=u,e.vx*=.985,e.vy*=.985,e.x+=e.vx,e.y+=e.vy,e.life--,e.life<=0&&(e.x=h()*l,e.y=h()*c,e.vx=(h()-.5)*1.5,e.vy=(h()-.5)*1.5,e.life=Math.floor(200*h())+100),e.x<0&&(e.x+=l),e.x>=l&&(e.x-=l),e.y<0&&(e.y+=c),e.y>=c&&(e.y-=c)}(s,e.type,e.cx1,e.cy1,e.cx2,e.cy2,e.strength,e.seed,t.width,t.height,e.rng);let o=s.life/s.maxLife*.6,i=1+.3*Math.sqrt(s.vx*s.vx+s.vy*s.vy);a.beginPath(),a.arc(s.x/t.width*r,s.y/t.height*n,i,0,2*Math.PI),a.fillStyle=`rgba(${l[0]}, ${l[1]}, ${l[2]}, ${o})`,a.fill()}s.current=requestAnimationFrame(i)};s.current=requestAnimationFrame(i);let l=()=>{n()};return window.addEventListener("resize",l),()=>{cancelAnimationFrame(s.current),window.removeEventListener("resize",l)}},[r]),(0,t.jsxs)("div",{className:"pointer-events-none absolute inset-0 overflow-hidden",children:[(0,t.jsx)("div",{className:"absolute inset-0",style:{backgroundImage:"linear-gradient(rgba(255,255,255,0.03) 1px, transparent 1px), linear-gradient(90deg, rgba(255,255,255,0.03) 1px, transparent 1px)",backgroundSize:"64px 64px"}}),(0,t.jsx)("canvas",{ref:e,className:"absolute inset-0 w-full h-full opacity-50",style:{mixBlendMode:"screen"}}),(0,t.jsx)("div",{className:"absolute inset-0",style:{background:"radial-gradient(ellipse 80% 60% at 50% 40%, transparent 0%, rgba(0,0,0,0.6) 100%)"}})]})}var m=e.i(63060),g=e.i(25);function f({text:e,font:s='300 18px "Geist"',lineHeight:o=30,className:r,style:n,fallback:i,cursorRadius:l=36,cursorColor:c="var(--accent)"}){let h=(0,a.useRef)(null),{ready:d,prepareWithSegments:u,layoutNextLine:p}=(0,g.usePreText)("Geist");return((0,a.useEffect)(()=>{if(!d||!u||!p||!h.current)return;let t=h.current,a=u(e,s);if(!a)return;let r=!1,n=0,i=0,m=0,g=0;for(;t.firstChild;)t.removeChild(t.firstChild);let f=[],y=document.createElement("div");function w(e){let s=t.clientWidth;if(0===s)return[];let r={segmentIndex:0,graphemeIndex:0},n=0,i=[],l=0;for(;l++<500;){let t=s,l=0;if(e&&n+o>e.y&&n<e.y+e.height){let a=e.x,o=e.x+e.width;if(a<=0)t=s-(l=Math.max(0,o+12));else if(o>=s)t=Math.max(60,a-12);else{let e=a-12,r=s-o-12;e>=r?t=Math.max(60,e):(l=o+12,t=Math.max(60,r))}}t=Math.max(t,60);let c=r.segmentIndex,h=r.graphemeIndex,d=p(a,r,t);if(!d||(i.push({text:d.text.trimEnd(),y:n,indent:l}),r=d.end,n+=o,r.segmentIndex===c&&r.graphemeIndex===h))break}return i}function v(e){for(var a=e.length;f.length<a;){let e=document.createElement("div");e.style.cssText=`
