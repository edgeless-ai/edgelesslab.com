...
description: We pointed our agents at our own knowledge base and asked what they should
  be doing that they weren't. Then we built the fixes.
date: '2026-05-12'
tags:
- AI Agents
- Self-Improvement
...
The idea: every cron job that produces output should grade its own work. Not with a language model staring at it philosophically, but with a rubric. A checklist of concrete quality signals specific to that job's output type.
