  ...
  return (
    ...
    >
      <head>
        ...
        <meta httpEquiv="Content-Security-Policy" content="default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' us.i.posthog.com us-assets.i.posthog.com gumroad.com *.gumroad.com; connect-src 'self' us.i.posthog.com us-assets.i.posthog.com gumroad.com *.gumroad.com; frame-src gumroad.com *.gumroad.com; img-src 'self' data: https:; style-src 'self' 'unsafe-inline'; font-src 'self' fonts.gstatic.com;" />
