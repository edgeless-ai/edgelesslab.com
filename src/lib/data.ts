export const projects = [
  ...
  },
  {
    ...
    longDescription: "A generative art pipeline that produces SVG artwork optimized for pen plotters. Over 105 experiments exploring strange attractors, Hilbert curves, Voronoi tessellations, and flow fields. Each piece is scored by an AI judge on composition, line quality, and visual interest. The best pieces get plotted on an AxiDraw with archival ink on cotton paper.",
  ...
  },
  {
    slug: "knowledge-api",
    title: "Knowledge API",
    description: "Semantic search across 7,000+ documents. ChromaDB + Obsidian + vector embeddings.",
...
export const experiments = [
  ...
  },
  {
    ...
    description: "Force-directed visualization of 7,000+ documents across ChromaDB collections, Obsidian vault links, and semantic similarity edges.",
    category: "Data",
    status: "Live",
  },
  {
  ...
  },
  {
    slug: "pen-plotter-art",
    title: "Pen Plotter Art",
    description: "Generative SVG art pipeline with AI scoring. Over 75 unique generators producing work across flow fields, attractors, tessellations, and algorithmic calligraphy.",
    category: "Generative",
