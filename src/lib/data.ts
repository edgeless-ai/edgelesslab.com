...
export const experiments = [
  {
    ...
    longDescription: [
      ...
      "The attractor generators feed into the larger pen-plotter autoresearch corpus alongside flow fields, op-art, and constructivist studies. The full scored catalog with 16,732 specimens is browsable in the field journal.",
    ],
    highlights: [
      ...
      "Outputs feed the pen plotter autoresearch catalog alongside 16 other factories",
    ],
  ...
  },
  {
    ...
    longDescription: [
      ...
      "16,732 specimens have been scored to date. The full editorial field journal — including the discovery that 26% of the algorithmic top-50 are 'grey rectangles' the algorithms loved but Claude rated 1.8/10 — is published as a separate artifact.",
    ],
    highlights: [
